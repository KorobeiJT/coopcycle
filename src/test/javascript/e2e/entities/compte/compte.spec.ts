...
describe('Compte e2e test', () => {
  ...
  it('should load Comptes', async () => {
    ...
    expect(await compteComponentsPage.getTitle()).to.eq('dmApp.compte.home.title');
  ...
  it('should load create Compte page', async () => {
    ...
    expect(await compteUpdatePage.getPageTitle()).to.eq('dmApp.compte.home.createOrEditLabel');
  ...
  it('should create and save Comptes', async () => {
    ...
    await promise.all([
      ...
      compteUpdatePage.setRoleInput('role'),
    ...
    expect(await compteUpdatePage.getRoleInput()).to.eq('role', 'Expected Role value to be equals to role');
  ...
  it('should delete last Compte', async () => {
    ...
    expect(await compteDeleteDialog.getDialogTitle()).to.eq('dmApp.compte.delete.question');
