...
describe('Course e2e test', () => {
  ...
  it('should load Courses', async () => {
    ...
    expect(await courseComponentsPage.getTitle()).to.eq('dmApp.course.home.title');
  ...
  it('should load create Course page', async () => {
    ...
    expect(await courseUpdatePage.getPageTitle()).to.eq('dmApp.course.home.createOrEditLabel');
  ...
  it('should create and save Courses', async () => {
    ...
    await promise.all([courseUpdatePage.setTimeRequiredInput('5'), courseUpdatePage.panierSelectLastOption()]);
  ...
  it('should delete last Course', async () => {
    ...
    expect(await courseDeleteDialog.getDialogTitle()).to.eq('dmApp.course.delete.question');
