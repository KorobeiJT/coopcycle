...
describe('SystemePaiement e2e test', () => {
  ...
  it('should load SystemePaiements', async () => {
    ...
    expect(await systemePaiementComponentsPage.getTitle()).to.eq('dmApp.systemePaiement.home.title');
    await browser.wait(
  ...
  it('should load create SystemePaiement page', async () => {
    ...
    expect(await systemePaiementUpdatePage.getPageTitle()).to.eq('dmApp.systemePaiement.home.createOrEditLabel');
  ...
  it('should delete last SystemePaiement', async () => {
    ...
    expect(await systemePaiementDeleteDialog.getDialogTitle()).to.eq('dmApp.systemePaiement.delete.question');
