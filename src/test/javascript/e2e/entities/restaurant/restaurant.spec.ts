...
describe('Restaurant e2e test', () => {
  ...
  it('should load Restaurants', async () => {
    ...
    expect(await restaurantComponentsPage.getTitle()).to.eq('dmApp.restaurant.home.title');
  ...
  it('should load create Restaurant page', async () => {
    ...
    expect(await restaurantUpdatePage.getPageTitle()).to.eq('dmApp.restaurant.home.createOrEditLabel');
  ...
  it('should create and save Restaurants', async () => {
    ...
    await promise.all([
      ...
      restaurantUpdatePage.setProductsInput('products'),
      // restaurantUpdatePage.compteSelectLastOption(),
      // restaurantUpdatePage.courseSelectLastOption(),
    ...
    expect(await restaurantUpdatePage.getProductsInput()).to.eq('products', 'Expected Products value to be equals to products');
  ...
  it('should delete last Restaurant', async () => {
    ...
    expect(await restaurantDeleteDialog.getDialogTitle()).to.eq('dmApp.restaurant.delete.question');
